...
/**
 * 使用HttpClient模拟发送（http/https）请求, 返回结果更改为含http状态以及内容的封装类
 * @see ResponseResult
 *
 * @author arron
 * @version 1.0
...
public class HttpClientWrapper {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult get(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult post(HttpClient client, String url, Header[] headers, Map<String, Object> parasMap,
			HttpContext context, String encoding) throws HttpProcessException {
		return post(HttpConfig.custom().client(client).url(url).headers(headers).map(parasMap).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult post(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult put(HttpClient client, String url, Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return put(HttpConfig.custom().client(client).url(url).headers(headers).map(parasMap).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult put(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult delete(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult patch(HttpClient client, String url, Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return patch(HttpConfig.custom().client(client).url(url).headers(headers).map(parasMap).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult patch(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult head(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult options(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult trace(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static OutputStream down(HttpClient client, String url, Header[] headers, HttpContext context,
			OutputStream out) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult upload(HttpClient client, String url, Header[] headers, HttpContext context)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult upload(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException    http处理异常
	 */
	public static ResponseResult send(HttpConfig config) throws HttpProcessException {
		return buildResponse(execute(config), config.outenc());
	}
